...
require_once("config.php");
	echo '<script type="text/javascript">setTimeout(function() { window.location.href = "' . $gBaseUrl . '/tlogout.php"; }, 15 * 60000);</script>';
?>
<link rel="stylesheet" type="text/css" href="js/css/flexigrid.pack.css" />
<link rel="stylesheet" href="css/jquery.mobile-1.2.0.min.css" />
<script type="text/javascript" src="js/nymphq-1.0.0.js"></script>
...
<script type="text/javascript" src="timerPing.js?20221014A"></script>
...
<script>
    ...
    function goIDXWatchlist(){
        window.location = "IDXwatchlist.php";
    }
    function goChgPin() {
	...
	function goRightIssue(){
		window.location = "formRight.php";
	}
	/*function goWatchlist() {
		window.location = "watchlist.php";
	}*/
