	...
	function setInput() {
		...
		$("#chgBtn").click(function(){
			...
			if((nPass == '') || (cPass == '')){
				...
				alert('Please input the pin at least 8 character');
				return;
			}
			else if( (isNaN(nPass)||(isNaN(cPass))) ) {
				alert('Pin must digits (0-9)');
				return;
			}
			else{
				if(nPass == cPass){
