				...
				success: function(jsRet){
					...
					if (jsRet.status != 1) {
						...
						for (i = 0; i < cnt; i ++) {
							...
							if (jsRet.trade[i]["time"].length == 5) {
								jsRet.trade[i]["time"] = "0" + jsRet.trade[i]["time"];
									
							}
							// fill data
							cell_v = [
								jsRet.trade[i]["time"].replace(/(\w{2,2})(\w{2,2})(\w{2,2})/, '$1:$2:$3'), //mato 
								//jsRet.trade[i]["time"].replace(/(\w{1,2})(\w{2,2})(\w{2,2})/, '$1:$2:$3') || jsRet.trade[i]["time"].replace(/(\w{1,2})(\w{2,2})(\w{2,2})/, '$1:$2:$3'), //mato 
								code,
