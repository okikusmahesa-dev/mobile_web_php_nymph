...
<html>
<head> 
	<title>Buy Order Acceleration</title> 
			...
			$.ajax({
				...
				success: function(jsRet){
					if (jsRet.status != 1){
						...
						console.log(security_type.code);
...
<body>
	...
	<table width=320px border=0>
		<tr>
			<td colspan="3"><h2 style="margin-bottom: 0px;font-size:22px;">Buy Order Accel</h2>
