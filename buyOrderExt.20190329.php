...
//			}
			...
			if (flagB==0) {
				...
				$("#lotW").text(lot);
				$("#amtW").text(totalAmt2);
				// change to dialog by fahri
				$.mobile.changePage("#confirmDialog", { role: "dialog" } );
				$("#okConfirmBtn").one("click",function(){
					flagB++;
					processOrder('Y');
					tr189000(userId, code, "RG", price, lot);
				});
				$("#cancelBtn").one("click",function(){
		    		//$('[data-role=dialog]').dialog( "close" );
		    		$('#confirmDialog').dialog( "close" );
					//location
					window.location.href="buyOrderExt.php";
				});
...
<body style="background:#ffffff">
	...
	<table width=320px border=0>
		...
		<tr>
			<td width="15%">Code</td>
			<td width="25%" colspan="1"><input id="codeTxt" type="text" class="no-ime" data-mini="true" maxlength="6" /></td>
            <td witdh="5%">
...
<div id="confirmDialog" data-role="page">
    ...
    <div data-role="main" class="ui-content" style="background-color:#c4e2e2">
        <table border=0 width=100%>
            <tr>
                <td width="50%" style="color:#000000">User Id</td>
				<td id="userIdW" width="50%" style="color:#000000" align="right"></td>
            </tr>
            <tr>
                <td width="50%" style="color:#000000">Code</td>
				<td id="codeW" width="50%" style="color:#000000" align="right"></td>
            </tr>
            <tr>
                <td width="50%" style="color:#000000">Price</td>
				<td id="priceW" width="50%" style="color:#000000" align="right"></td>
            </tr>
            <tr>
                <td width="50%" style="color:#000000">Lot</td>
				<td id="lotW" width="50%" style="color:#000000" align="right"></td>
            </tr>
			<tr>
				<td width="50%" style="color:#000000">Amt</td>
				<td id="amtW" width="50%" style="color:#000000" align="right"></td>
			</tr>
            <tr>
                <td width="50%">
