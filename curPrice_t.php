			...
			$.ajax({
				...
				success: function(jsRet){
					if (jsRet.status != 1) {
                        ...
                        if(open > prevPrice){
                            $('#oprice').css('color', '#0000ff');
                        }else if(open < prevPrice){
                            $('#oprice').css('color', '#ff0000');
                        }else{
                            $('#oprice').css('color', '#000000');
                        }
                        
                        high > prevPrice ? $('#hprice').css('color', '#0000ff') : $('#hprice').css('color', '#ff0000');
					    if(high == prevPrice)  $('#hprice').css('color', '#000000');
                        low > prevPrice ? $('#lprice').css('color', '#0000ff') : $('#lprice').css('color', '#ff0000');
					    if(low > prevPrice) $('#lprice').css('color', '#000000');	
                        value > prevPrice ? $('#value').css('color', '#0000ff') : $('#value').css('color', '#ff0000');
					    if(value > prevPrice) $('#value').css('color', '#000000');	
