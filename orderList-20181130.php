...
<head> 
	...
	today = now.format("yyyymmdd");
		...
		$(document).ready(function() {
			...
			$("#cancelWithdraw").one("click",function(){
			...
			$("#cancelAmend").one("click",function(){
		...
		//		window.open("orderList-20181126.php","_self");			
			$('#volA').each(function(){
		        ...
		        if (isDisable){
					...
					window.open("orderList-20181130.php","_self");	
	...
	<div data-role="main" class="ui-content" style="background-color:#c4e2e2">
		<table border=0 width=100%>
			...
			<tr>
				...
				<td>
                    <a id="cancelWithdraw" href="#" data-role="button" autofocus>Cancel</a>
                </td>
			</tr>
		</table>
	</div>
	...
	<div data-role="main" class="ui-content" style="background-color:#ffe1a0">
		<table border=0 width=100%>
			...
			<tr>
				...
				<td>
                <a id="cancelAmend" href="#" autofocus data-role="button">Cancel</a>
                </td>
			</tr>
		</table>
	</div>
