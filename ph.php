<div data-role="header" data-theme="b">
	...
	<!--
	<a href="#popupMenu" data-rel="popup" data-role="button" data-inline="true" data-transition="fade" data-icon="home" data-theme="b">Actions</a>
	...
	<a href="#popupMenu" data-rel="popup" data-role="button" data-inline="true" data-transition="fade" data-icon="arrow-d" data-theme="b">Actions</a>
		<div data-role="popup" id="popupMenu" data-theme="b">
        	<ul data-role="listview" data-inset="true" style="min-width:210px;" data-theme="d">
		    	<!-- <li data-role="divider" data-theme="b">Choose an action</li> -->
				<li><a href="#" onclick="goRunning();return false;">Running Trade</a></li>
