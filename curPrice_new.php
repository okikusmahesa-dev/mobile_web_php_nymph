...
<head> 
	...
	<script type="text/javascript">
		...
		function qryTr100000() {
			...
			$("#codeTxt").val(code);
			var boardCode = $("#boardTxt").val();
			boardCode = boardCode.toUpperCase();
			$("#boardTxt").val(boardCode);
			$.mobile.loading('show');
			tr100000(code, boardCode);
			$.mobile.loading('hide');
		}
...
<? include "page-header.php" ?>
	<div style="border-style: dotted;">
		...
		<input id="boardTxt" type="text" value="RG" maxlength=2 style="float:left;width:100;text-align:center;ime-mode:disabled;text-transform:uppercase;" data-mini="true"/>
		<!--
		<input name="boardTxtt" id="boardTxt" type="radio" value="RG" style="float:right;" checked/>RG
		<input name="boardTxtt" id="boardTxt" type="radio" value="NG" style="float:right;"/>NG
		<input name="boardTxtt" id="boardTxt" type="radio" value="TN" style="float:left;"/>TN
		-->
