...
$pinState = 0;
$pinLogin = 0;
	echo '<script type="text/javascript">setTimeout(function() { window.location.href = "https://mobile.bcasekuritas.co.id/tlogout.php"; }, 1 * 10000);</script>';
...
<head> 
	...
	function setInput() {
		...
		$("#okBtn").click(function(){
			...
			if( chkTime() == "NO" ) {
				alert("Cannot order. Orders can be sent between (08.00 ~ 16.15)");
				return;
			}
