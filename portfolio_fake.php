...
$userId = "S749";     //$_SESSION["userId"];
$clientId = 'BCAS749';//$_SESSION["loginId"];
$pinState = 0;
$pinLogin = 0;
					...
					if (jsRet.status != 1) {
						...
						*/
						...
						for (i = 0; i < cnt; i ++) {
							...
							//jsRet.out[i].profitVal = Number(jsRet.out[i].balance) - Number(jsRet.out[i].stkVal);
							//jsRet.out[i].profitVal = Number(jsRet.out[i].mktVal) - Number(jsRet.out[i].stkVal); //mato
							...
							//}
							//console.log(shares + " + " + ops + " * " + bprc);
							mval = jsRet.out[i].mktVal;
							//console.log('offer: '+ ops);	
							//console.log('bval: '+ bval);	
							//mato
							if (shares == 0) {
								jsRet.out[i].profitVal = Number(jsRet.out[i].balance) - Number(bval);
							}else {
								//jsRet.out[i].profitVal = Number(jsRet.out[i].mktVal) - Number(bval);
			...
			$.ajax({
				...
				success: function(jsRet) {
					if (jsRet.status != 1) {
						...
						//console.log("debt="+ debt + " || asset="+ asset );
						//console.log("asset="+ totLq + " + "+ ordList );
