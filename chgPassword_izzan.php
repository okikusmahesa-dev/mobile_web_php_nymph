...
<head> 
	...
	function setInput() {
		...
		$("#okBtn").click(function(){
			...
			if( chkTime() == "NO" ) {
				alert("Cannot order. Orders can be sent between (08.30 ~ 16.15)");
				return;
			}
...
*/
	...
	$("#chgBtn").click(function(){
		ret = 0;
		//nPassLen = document.getElementById('nPassTxt').value.length;
		//nPass = document.getElementById('nPassTxt').value;
		//cPass = document.getElementById('cPassTxt').value;
		
		if(document.getElementById('nPassTxt').value.length < 8 || document.getElementById('nPassTxt').value.length > 20){
			alert("Password cannot be less than 8 or more than 20.");
			return;
		}
		if(nPass == cPass){
		 	ret = 1;
		 	...
		 	alert("Password and Confirm Password did not same, check again.");
		 	return;
		}

		if(ret == 1){
		 	login_id = document.getElementById('loginTxt').value;
			password = document.getElementById('nPassTxt').value;
			tr800901(login_id,password);
		}
	});
